          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {firstLoadDone ? (
              <>
                ...
                {status && (
                  <div className="flex flex-col gap-2 animate-fade-in">
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`px-3 py-1 rounded text-sm font-semibold uppercase ${status.toLowerCase() === 'accepted' ? 'text-green-400 bg-green-900/20 border border-green-500/20' :
                ...
                {/* Message Banner */}
                {message && (
                  <div className={`p-3 rounded-lg text-center text-sm ${message.toLowerCase().includes("fail") || message.toLowerCase().includes("error")
